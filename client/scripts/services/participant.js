...
angular.module('dashboardApp')
  .service('participant', function ($http) {
    ...
    this.getParticipant = function (participantId) {
      ...
      $http.get('http://localhost:3000/api/employees/'+participantId)
    ...
    this.deleteParticipant = function(pId) {
      $http.delete('http://localhost:3000/api/employees/'+pId)
    ...
    this.updateParticipant = function(newParticipant) {
      ...
      $http.put('http://localhost:3000/api/projects/' + newParticipant._id, newParticipant)
        .success(function (item) {
